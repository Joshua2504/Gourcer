...
gource ${tmp_dir}/combined.txt --seconds-per-day 0.3 --auto-skip-seconds 0.1 --title "$title" --disable-auto-rotate --camera-mode overview --user-friction 1 --max-user-speed 15 --filename-time 5 --highlight-users --time-scale 4 --user-scale 5 -${resolution} -o - | \
